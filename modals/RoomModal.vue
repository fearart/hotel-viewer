<template>
    ...
    >
        ...
        <div class="flex flex-col justify-center space-y-2 w-full">
            ...
            <UButton label="Cancel" color="error" class="mr-2" @click="emitClose"></UButton>
            <UButton v-if="props.activeRoom.alarm" icon="i-heroicons-bell" color="error" @click="toggleAlarm" class="mr-2"/>
            ...
            <UButton label="✔" color="success" class="mr-2" @click="setEverythingGreen"></UButton>
            <UButton v-if="props.user.permissions.root" label="🗑️" color="error" @click="deleteRoom"></UButton>
            </div>
            <div class="flex flex-row h-10 w-full justify-center">
        ...
        <template #body>
        <UTabs :items="modalItems" class="px-2 mt-2" variant="link">
        <template #content="{ item }">
            ...
            <div v-if="item.key === 'P'" class="m-2 flex flex-col items-center">
            <div class="flex flex-row">
                <div class="pr-2 h-20 w-20">
            ...
            <div v-if="item.key === 'K'" class="m-2 flex flex-col items-center">
            <div class="flex flex-row">
                <div class="pr-2 h-20 w-20">
            ...
            <div v-if="item.key === 'E'" class="m-2 flex flex-col items-center">
            <div class="flex flex-row">
                <div class="pr-2 h-20 w-20">
            ...
            <div v-if="item.key === 'A'" class="m-2 flex flex-col items-center">
            ...
            <UButton :disabled="props.activeRoom.administracja.isApproved === 'Yes'" label="Zatwierdz" icon="i-heroicons-check-circle" color="primary" variant="solid" @click="acceptRoom" class="right-0 top-0 m-2"/>
